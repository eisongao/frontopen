...
<article id="post-166" class="post-166 ost type-post status-publish format-standard has-post-thumbnail category-bussinus category-entertainment category-miscellaneous single-content clearfix" >
<?php if ($video == "1"): ?>
<div class="featured">
<?php if (is_mobile() ): ?>
