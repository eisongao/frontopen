...
<article id="post-146" class="post-146 post type-post status-publish format-video has-post-thumbnail category-fasion tag-girl post_format-post-format-video featured-post single-content clearfix">
<div class="featured">
<?php if (is_mobile() ): ?>
