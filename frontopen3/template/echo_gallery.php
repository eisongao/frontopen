...
<article id="post-166" class="post-166 post type-post status-publish format-standard has-post-thumbnail category-bussinus category-entertainment category-miscellaneous single-content clearfix" >
<?php if ($video == "1"): ?>
<div class="featured">
<?php if (is_mobile() ): ?>
...
<ul class="spostinfo">
<li class="cop"><strong>版权声明：</strong>本文章发表于 <?php echo gmdate('Y-n-j G:i', $date); ?> ，由 <?php blog_author($author); ?> 发布</li>
<li><strong>转载注明：</strong><a href="<?php echo $val['url']; ?>" rel="bookmark"><?php echo $log_title; ?></a>
...
<meta itemprop="interactionCount" content="UserArticles:21"> </section>
